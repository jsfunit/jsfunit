...
<f:view>  
   <h1><h:outputText value="JSFUnit HelloJSF Demo Application - JSF 1.2 Only" id="title"/></h1>
   ...
   <h:panelGrid columns="3" border="1" cellpadding="2" id="panelGrid">
      <h:outputText value="JSF1_2Test"/>
      <h:outputLink id="RunJSF1_2Test" 
                  value="ServletTestRunner?suite=org.jboss.jsfunit.example.hellojsf.JSF1_2Test&xsl=cactus-report.xsl">
          <h:outputText value="Run Test"/>
      </h:outputLink>
      <h:outputLink id="SourceJSF1_2Testt" 
                  value="JSF1_2Test.java">
