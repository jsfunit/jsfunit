...
<f:view>  
   <h1><h:outputText value="JSFUnit Basic Authentication Demo Application" id="title"/></h1>
   <h:outputText value="sample username=admin password=adminpw" id="username_password"/> 
   ...
   <h:panelGrid columns="3" border="1" cellpadding="2" id="panelGrid">
      ...
      <h:outputLink id="RunBasicAuthenticationTest" 
                  value="ServletTestRunner?suite=org.jboss.jsfunit.example.authentication.basic.BasicAuthenticationTest&xsl=cactus-report.xsl">
