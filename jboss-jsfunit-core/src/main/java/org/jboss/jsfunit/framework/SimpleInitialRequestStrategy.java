...
public class SimpleInitialRequestStrategy implements InitialRequestStrategy
{
    ...
    *
    * @return The Page obejct returned by HtmlUnit when the request is complete.
    *
    * @throws IOException if HtmlUnit encounters an error.
    */
   public Page doInitialRequest(WebClientSpec wcSpec) throws IOException
   {
      String url = WebConversationFactory.getWARURL() + wcSpec.getInitialPage();
      return wcSpec.getWebClient().getPage(url);
   }
