...
public class ApplicationFactoryTestCase extends AbstractInterfaceTestCase
{
    ...
    */
   public ApplicationFactoryTestCase(String name, String className)
   {
      super(name, "Application Factory", className);
   }

   @Override
   protected Class<?> getClassToExtend()
   {
      return javax.faces.application.ApplicationFactory.class;
   }
}
