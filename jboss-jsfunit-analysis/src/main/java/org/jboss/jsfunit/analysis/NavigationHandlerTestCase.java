...
public class NavigationHandlerTestCase extends AbstractInterfaceTestCase
{
    ...
    */
   public NavigationHandlerTestCase(String name, String className)
   {
      super(name, "Navigation Handler", className);
   }

   @Override
   protected Class<?> getClassToExtend()
   {
      return javax.faces.application.NavigationHandler.class;
   }
}
